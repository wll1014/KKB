...
<script>
	export default{
		...
		methods: {
            ...
            if(res.data.data.info[0].bitrate){
              this.terminalFormInfo.bitrate= res.data.data.info[0].bitrate +"kbps"
            }
            if(res.data.data.info[0].mt_expe){
              this.terminalFormInfo.mt_expe= res.data.data.info[0].mt_expe +"分"
            }
            ...
            this.terminalDeraildata = [{
              ...
              mt_e164: this.peertopeerdata.caller_id,
