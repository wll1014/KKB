<template>
  <div style="width: 100%;height:100%;">
    ...
    <div style="width: 100%;height: 462px;margin-top: 10px;">
      <ChartExtendLargeModel ChartID="IDLoadUtilization" :chartConf="activeChartConf" :extraPlugin="extraPlugin" extraPluginClass="area-chart-plugin--cpu"></ChartExtendLargeModel>
    </div>
  </div>
</template>
